...
public class StarredEventsListAdapter extends ArrayAdapter<Event>{
    ...
    public StarredEventsListAdapter(ArrayList<Event> data, Context context) {
        super(context, R.layout.starred_list_item, data);
        this.dataSet = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.starred_list_item, parent, false);
